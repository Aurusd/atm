...
public class EmbeddedJetty {
    ...
    private static final String CONFIG_LOCATION_PACKAGE = "com.mpsdevelopment.biopotential.server.config";
    private static final String MAPPING_URL = "/";
    private static final String WEBAPP_DIRECTORY = "webapp";
    
    public static void main(String[] args) throws Exception {
        new EmbeddedJetty().start(PORT);
    }
    ...
    public static ServletContextHandler getServletContextHandler() throws IOException {
